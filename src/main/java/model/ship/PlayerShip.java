...
public class PlayerShip implements Ship {
    ...
    /**
     * moves on tic update based on the direction, rotation and speed the ship has,
     * updates position
     * 
    ...
    /**
     * slows down the ship gradually (P.S.: Space doesn't have friction for this to
     * happen)
     */
	...
	// TODO might be redundant because player controlled aim, targeting seems not
	// fun
    }
    ...
    /**
     * not useful for player, dedicated to enemy ships, potentially reworkable to
     * drop the player gun
     * 
     * @return null
     */
